...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'balitawoo' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'balitawoo' ),
		'repeat-y'  => __( 'Repeat Vertically', 'balitawoo' ),
		'repeat'    => __( 'Repeat All', 'balitawoo' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'balitawoo' ),
		'top center'    => __( 'Top Center', 'balitawoo' ),
		'top right'     => __( 'Top Right', 'balitawoo' ),
		'center left'   => __( 'Middle Left', 'balitawoo' ),
		'center center' => __( 'Middle Center', 'balitawoo' ),
		'center right'  => __( 'Middle Right', 'balitawoo' ),
		'bottom left'   => __( 'Bottom Left', 'balitawoo' ),
		'bottom center' => __( 'Bottom Center', 'balitawoo' ),
		'bottom right'  => __( 'Bottom Right', 'balitawoo')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'balitawoo' ),
		'fixed'  => __( 'Fixed in Place', 'balitawoo')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'balitawoo' ),
		'italic'      => __( 'Italic', 'balitawoo' ),
		'bold'        => __( 'Bold', 'balitawoo' ),
		'bold italic' => __( 'Bold Italic', 'balitawoo' )
	);

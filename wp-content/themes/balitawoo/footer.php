...
<div class="wave"></div>
	...
	<div class="foot">
		<div class="w1170">
			<img class="foothome" src="<?php echo get_template_directory_uri(); ?>/img/footerleft.png" width="202" height="190">
			<img class="footapolo" src="<?php echo get_template_directory_uri(); ?>/img/footerright.png" width="202" height="190">
			<div class="pay">
